...
// splicer begin function.inout_init_mpi
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "sO:inout_init", const_cast<char **>(SHT_kwlist), &fileName, &comm))
        return nullptr;
...
static char PY_inout_set_dimension__doc__[] =
"documentation"
;

static PyObject *
PY_inout_set_dimension(
  PyObject *SHROUD_UNUSED(self),
  PyObject *args,
  PyObject *kwds)
{
// splicer begin function.inout_set_dimension
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "i:inout_set_dimension", const_cast<char **>(SHT_kwlist), &dim))
        return nullptr;
...
// splicer begin function.inout_set_verbose
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!:inout_set_verbose", const_cast<char **>(SHT_kwlist), &PyBool_Type, &SHPy_verbosity))
        return nullptr;
...
// splicer begin function.inout_set_vertex_weld_threshold
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "d:inout_set_vertex_weld_threshold", const_cast<char **>(SHT_kwlist), &thresh))
        return nullptr;
...
static char PY_inout_set_segments_per_knot_span__doc__[] =
"documentation"
;

static PyObject *
PY_inout_set_segments_per_knot_span(
  PyObject *SHROUD_UNUSED(self),
  PyObject *args,
  PyObject *kwds)
{
// splicer begin function.inout_set_segments_per_knot_span
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "i:inout_set_segments_per_knot_span", const_cast<char **>(SHT_kwlist), &segmentsPerKnotSpan))
        return nullptr;
...
// splicer begin function.inout_evaluate
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "dd|d:inout_evaluate", const_cast<char **>(SHT_kwlist), &x, &y, &z))
        return nullptr;
    switch (SH_nargs) {
    case 2:
...
// splicer begin function.signed_distance_init_mpi
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "sO:signed_distance_init", const_cast<char **>(SHT_kwlist), &file, &comm))
        return nullptr;
...
// splicer begin function.signed_distance_init_serial
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "s:signed_distance_init", const_cast<char **>(SHT_kwlist), &file))
        return nullptr;
    const std::string SH_file(file);
...
// splicer begin function.signed_distance_set_dimension
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "i:signed_distance_set_dimension", const_cast<char **>(SHT_kwlist), &dim))
        return nullptr;
...
// splicer begin function.signed_distance_set_closed_surface
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!:signed_distance_set_closed_surface", const_cast<char **>(SHT_kwlist), &PyBool_Type, &SHPy_status))
        return nullptr;
...
// splicer begin function.signed_distance_set_compute_signs
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!:signed_distance_set_compute_signs", const_cast<char **>(SHT_kwlist), &PyBool_Type, &SHPy_computeSign))
        return nullptr;
...
static char PY_signed_distance_set_allocator__doc__[] =
"documentation"
;

static PyObject *
PY_signed_distance_set_allocator(
  PyObject *SHROUD_UNUSED(self),
  PyObject *args,
  PyObject *kwds)
{
// splicer begin function.signed_distance_set_allocator
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "i:signed_distance_set_allocator", const_cast<char **>(SHT_kwlist), &allocatorID))
        return nullptr;
...
// splicer begin function.signed_distance_set_verbose
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!:signed_distance_set_verbose", const_cast<char **>(SHT_kwlist), &PyBool_Type, &SHPy_status))
        return nullptr;
    status = PyObject_IsTrue(SHPy_status);
...
// splicer begin function.signed_distance_use_shared_memory
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!:signed_distance_use_shared_memory", const_cast<char **>(SHT_kwlist), &PyBool_Type, &SHPy_status))
        return nullptr;
    status = PyObject_IsTrue(SHPy_status);
...
static char PY_signed_distance_set_execution_space__doc__[] =
"documentation"
;

static PyObject *
PY_signed_distance_set_execution_space(
  PyObject *SHROUD_UNUSED(self),
  PyObject *args,
  PyObject *kwds)
{
// splicer begin function.signed_distance_set_execution_space
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "i:signed_distance_set_execution_space", const_cast<char **>(SHT_kwlist), &execSpace))
        return nullptr;
...
// splicer begin function.signed_distance_evaluate_0
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "ddd:signed_distance_evaluate", const_cast<char **>(SHT_kwlist), &x, &y, &z))
        return nullptr;
...
// splicer begin function.signed_distance_evaluate_1
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "ddddddddd:signed_distance_evaluate", const_cast<char **>(SHT_kwlist), &x, &y, &z, &cp_x, &cp_y, &cp_z, &n_x, &n_y, &n_z))
        return nullptr;
...
{"inout_set_dimension", (PyCFunction)PY_inout_set_dimension, METH_VARARGS|METH_KEYWORDS, PY_inout_set_dimension__doc__},
{"inout_set_verbose", (PyCFunction)PY_inout_set_verbose, METH_VARARGS|METH_KEYWORDS, PY_inout_set_verbose__doc__},
{"inout_set_vertex_weld_threshold", (PyCFunction)PY_inout_set_vertex_weld_threshold, METH_VARARGS|METH_KEYWORDS, PY_inout_set_vertex_weld_threshold__doc__},
{"inout_set_segments_per_knot_span", (PyCFunction)PY_inout_set_segments_per_knot_span, METH_VARARGS|METH_KEYWORDS, PY_inout_set_segments_per_knot_span__doc__},
{"inout_evaluate", (PyCFunction)PY_inout_evaluate_1, METH_VARARGS|METH_KEYWORDS, PY_inout_evaluate_1__doc__},
...
{"signed_distance_initialized", (PyCFunction)PY_signed_distance_initialized, METH_NOARGS, PY_signed_distance_initialized__doc__},
{"signed_distance_set_dimension", (PyCFunction)PY_signed_distance_set_dimension, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_dimension__doc__},
{"signed_distance_set_closed_surface", (PyCFunction)PY_signed_distance_set_closed_surface, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_closed_surface__doc__},
{"signed_distance_set_compute_signs", (PyCFunction)PY_signed_distance_set_compute_signs, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_compute_signs__doc__},
{"signed_distance_set_allocator", (PyCFunction)PY_signed_distance_set_allocator, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_allocator__doc__},
{"signed_distance_set_verbose", (PyCFunction)PY_signed_distance_set_verbose, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_verbose__doc__},
{"signed_distance_use_shared_memory", (PyCFunction)PY_signed_distance_use_shared_memory, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_use_shared_memory__doc__},
{"signed_distance_set_execution_space", (PyCFunction)PY_signed_distance_set_execution_space, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_set_execution_space__doc__},
{"signed_distance_finalize", (PyCFunction)PY_signed_distance_finalize, METH_NOARGS, PY_signed_distance_finalize__doc__},
{"inout_init", (PyCFunction)PY_inout_init, METH_VARARGS|METH_KEYWORDS, PY_inout_init__doc__},
{"signed_distance_init", (PyCFunction)PY_signed_distance_init, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_init__doc__},
{"signed_distance_evaluate", (PyCFunction)PY_signed_distance_evaluate, METH_VARARGS|METH_KEYWORDS, PY_signed_distance_evaluate__doc__},
