...
module axom_spio
    ...
    interface assignment (=)
        module procedure io_manager_assign_IOManager
    end interface
    ...
    interface
        ...
        subroutine c_io_manager_ctor_default_bufferify(com, SHT_rv) &
                bind(C, name="SPIO_IOManager_ctor_default_bufferify")
            use iso_c_binding, only : C_INT
            import :: SPIO_SHROUD_capsule_data
            implicit none
            integer(C_INT), value, intent(IN) :: com
            type(SPIO_SHROUD_capsule_data), intent(OUT) :: SHT_rv
        end subroutine c_io_manager_ctor_default_bufferify
        ...
        subroutine c_io_manager_ctor_usescr_bufferify(com, use_scr, &
                SHT_rv) &
                bind(C, name="SPIO_IOManager_ctor_usescr_bufferify")
            ...
            logical(C_BOOL), value, intent(IN) :: use_scr
            type(SPIO_SHROUD_capsule_data), intent(OUT) :: SHT_rv
        end subroutine c_io_manager_ctor_usescr_bufferify
...
contains
    ...
    function io_manager_ctor_default(com) &
        ...
        call c_io_manager_ctor_default_bufferify(com, SHT_rv%cxxmem)
    ...
    function io_manager_ctor_usescr(com, use_scr) &
        ...
        logical(C_BOOL) :: SHT_use_scr_cxx
        SHT_use_scr_cxx = use_scr  ! coerce to C_BOOL
        call c_io_manager_ctor_usescr_bufferify(com, SHT_use_scr_cxx, &
            SHT_rv%cxxmem)
    ...
    subroutine io_manager_read_1(obj, group, file_string, protocol, &
        ...
        integer(C_INT) SHT_file_string_len
        integer(C_INT) SHT_protocol_len
        logical(C_BOOL) :: SHT_preserve_contents_cxx
        SHT_file_string_len = len(file_string, kind=C_INT)
        SHT_protocol_len = len(protocol, kind=C_INT)
        SHT_preserve_contents_cxx = preserve_contents  ! coerce to C_BOOL
        call c_io_manager_read_1_bufferify(obj%cxxmem, group%cxxmem, &
            file_string, SHT_file_string_len, protocol, &
            SHT_protocol_len, SHT_preserve_contents_cxx)
    ...
    subroutine io_manager_read_3(obj, group, root_file, &
        ...
        call c_io_manager_read_3_bufferify(obj%cxxmem, group%cxxmem, &
            root_file, SHT_root_file_len, SHT_preserve_contents_cxx)
    ...
    subroutine io_manager_assign_IOManager(lhs, rhs)
        use iso_c_binding, only : c_associated, c_f_pointer
        class(iomanager), intent(INOUT) :: lhs
        type(iomanager), intent(IN) :: rhs
        interface
            subroutine do_assign(lhs, rhs) bind(C, &
                name="SPIO_IOManager_assign_IOManager")
                import :: SPIO_SHROUD_capsule_data
                type(SPIO_SHROUD_capsule_data), intent(INOUT) :: lhs
                type(SPIO_SHROUD_capsule_data), intent(IN) :: rhs
            end subroutine do_assign
        end interface
        call do_assign(lhs%cxxmem, rhs%cxxmem)
    end subroutine io_manager_assign_IOManager
