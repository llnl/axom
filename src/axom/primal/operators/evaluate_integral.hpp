 ...
 *
 * Line integrals are computed with 1D quadrature rules supplied by MFEM if available, 
 * or by methods in "core/numerics/quadrature" otherwise, which are less robust for 
 * high numbers of quadrature points (> ~100)
