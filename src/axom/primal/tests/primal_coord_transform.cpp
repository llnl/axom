...
//------------------------------------------------------------------------------
TEST(primal_coord_transform, translation) { check_translation<axom::SEQ_EXEC>(); }
...
//------------------------------------------------------------------------------
TEST(primal_coord_transform, rotate_to_axis) { check_rotate_to_axis<axom::SEQ_EXEC>(); }
...
//------------------------------------------------------------------------------
TEST(primal_coord_transform, translate_rotate) { check_translate_rotate<axom::SEQ_EXEC>(); }
...
//------------------------------------------------------------------------------
TEST(primal_coord_transform, to_dest_pts) { check_to_dst_pts<axom::SEQ_EXEC>(); }
...
//------------------------------------------------------------------------------
TEST(primal_coord_transform, inverse) { check_inverse<axom::SEQ_EXEC>(); }
