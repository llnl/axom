...
extern "C" void create_record_(char *, char *, int, int);
...
extern "C" void write_sina_document_noprotocol_nopreserve_nomerge(char *);
extern "C" void write_sina_document_protocol_nopreserve_nomerge(char *, int *);
extern "C" void write_sina_document_protocol_preserve_nomerge(char *, int *, int *);
extern "C" void write_sina_document_all_args(char *, int *, int *, int*);
...
extern "C" void sina_add_curve_double_(char *, char *, double *, int *, bool *, char *, int, int, int);
extern "C" void sina_add_curve_float_(char *, char *, float *, int *, bool *, char *, int, int, int);
extern "C" void sina_add_curve_int_(char *, char *, int *, int *, bool *, char *, int, int, int);
extern "C" void sina_add_curve_long_(char *, char *, long long int *, int *, bool *, char *, int, int, int);
