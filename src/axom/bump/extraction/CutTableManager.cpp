    ...
    if(!m_tables[index].isLoaded())
    {
      if(shape == ST_TRI)
      {
        m_tables[index].load(numCutCasesTri,
                             ...
                             startCutShapesTri,
                             cutShapesTri,
                             cutShapesTriSize, m_allocatorID);
      }
...
/*
      else if(shape == ST_POLY5)
      {
        m_tables[index].load(numCutCasesPoly5,
                             ...
                             startCutShapesPoly5,
                             cutShapesPoly5,
                             cutShapesPoly5Size, m_allocatorID);
      }
      else if(shape == ST_POLY6)
      {
        m_tables[index].load(numCutCasesPoly6,
                             ...
                             startCutShapesPoly6,
                             cutShapesPoly6,
                             cutShapesPoly6Size, m_allocatorID);
      }
      else if(shape == ST_POLY7)
      {
        m_tables[index].load(numCutCasesPoly7,
                             ...
                             startCutShapesPoly7,
                             cutShapesPoly7,
                             cutShapesPoly7Size, m_allocatorID);
      }
...
*/
      else if(shape == ST_TET)
      {
        m_tables[index].load(numCutCasesTet,
                             ...
                             startCutShapesTet,
                             cutShapesTet,
                             cutShapesTetSize, m_allocatorID);
      }
      else if(shape == ST_PYR)
      {
        m_tables[index].load(numCutCasesPyr,
                             ...
                             startCutShapesPyr,
                             cutShapesPyr,
                             cutShapesPyrSize, m_allocatorID);
      }
      else if(shape == ST_WDG)
      {
        m_tables[index].load(numCutCasesWdg,
                             ...
                             startCutShapesWdg,
                             cutShapesWdg,
                             cutShapesWdgSize, m_allocatorID);
      }
      else if(shape == ST_HEX)
      {
        m_tables[index].load(numCutCasesHex,
                             ...
                             startCutShapesHex,
                             cutShapesHex,
                             cutShapesHexSize, m_allocatorID);
      }
    }
  }
