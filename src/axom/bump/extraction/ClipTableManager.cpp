    ...
    if(!m_tables[index].isLoaded())
    {
      if(shape == ST_TRI)
      {
        m_tables[index].load(numClipCasesTri,
                             ...
                             startClipShapesTri,
                             clipShapesTri,
                             clipShapesTriSize, m_allocatorID);
      }
      else if(shape == ST_QUA)
      {
        m_tables[index].load(numClipCasesQua,
                             ...
                             startClipShapesQua,
                             clipShapesQua,
                             clipShapesQuaSize, m_allocatorID);
      }
      else if(shape == ST_POLY5)
      {
        m_tables[index].load(numClipCasesPoly5,
                             ...
                             clipShapesPoly5,
                             clipShapesPoly5Size, m_allocatorID);
      }
      else if(shape == ST_POLY6)
      {
        m_tables[index].load(numClipCasesPoly6,
                             ...
                             clipShapesPoly6,
                             clipShapesPoly6Size, m_allocatorID);
      }
      else if(shape == ST_POLY7)
      {
        m_tables[index].load(numClipCasesPoly7,
                             ...
                             clipShapesPoly7,
                             clipShapesPoly7Size, m_allocatorID);
      }
      ...
      else if(shape == ST_TET)
      {
        m_tables[index].load(numClipCasesTet,
                             ...
                             startClipShapesTet,
                             clipShapesTet,
                             clipShapesTetSize, m_allocatorID);
      }
      else if(shape == ST_PYR)
      {
        m_tables[index].load(numClipCasesPyr,
                             ...
                             startClipShapesPyr,
                             clipShapesPyr,
                             clipShapesPyrSize, m_allocatorID);
      }
      else if(shape == ST_WDG)
      {
        m_tables[index].load(numClipCasesWdg,
                             ...
                             startClipShapesWdg,
                             clipShapesWdg,
                             clipShapesWdgSize, m_allocatorID);
      }
      else if(shape == ST_HEX)
      {
        m_tables[index].load(numClipCasesHex,
                             ...
                             startClipShapesHex,
                             clipShapesHex,
                             clipShapesHexSize, m_allocatorID);
      }
    }
  }
