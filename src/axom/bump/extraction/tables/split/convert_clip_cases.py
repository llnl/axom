...
def example():
    # Example usage:
    polygons = [('A', 'B', 'C', 'D'), ('C', 'D', 'E', 'F'), ('E', 'F', 'G', 'H'), ('X', 'Y', 'Z')]
...
def write_new_tables(filename, name, tableNames, sizes, offsets, shapes):
    ...
    f.write(
        f"const size_t {clip}Shapes{name}Size = sizeof({clip}Shapes{name}) / sizeof(unsigned char);\n\n"
    )
    f.write("}")
    f.write(f" // namespace {clipping}\n")
    f.write("} // namespace tables\n")
...
def make_polygonal_cut_tables():
    ...
    write_new_tables("../cutting/CutCasesPoly5.cpp", "Poly5", tableNames, outSizes, outOffsets,
                     outShapes)
    ...
    outSizes, outOffsets, outShapes = convert_clip_cases("ClipCasesPoly6.cpp",
                                                         ...
                                                         max_edges=20)
    outSizes, outOffsets, outShapes = make_cut_cases(outSizes, outOffsets, outShapes)
    write_new_tables("../cutting/CutCasesPoly6.cpp", "Poly6", tableNames, outSizes, outOffsets,
                     outShapes)
    ...
    outSizes, outOffsets, outShapes = convert_clip_cases("ClipCasesPoly7.cpp",
                                                         ...
                                                         max_edges=20)
    outSizes, outOffsets, outShapes = make_cut_cases(outSizes, outOffsets, outShapes)
    write_new_tables("../cutting/CutCasesPoly7.cpp", "Poly7", tableNames, outSizes, outOffsets,
                     outShapes)
    ...
    outSizes, outOffsets, outShapes = convert_clip_cases("ClipCasesPoly8.cpp",
                                                         ...
                                                         max_edges=20)
    outSizes, outOffsets, outShapes = make_cut_cases(outSizes, outOffsets, outShapes)
    write_new_tables("../cutting/CutCasesPoly8.cpp", "Poly8", tableNames, outSizes, outOffsets,
                     outShapes)
