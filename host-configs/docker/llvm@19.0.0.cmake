...
# Compilers
#------------------------------------------------------------------------------
# Compiler Spec: llvm@19.0.0/hpp37w5qjo4zc4cgogknua6ull7tes74
#------------------------------------------------------------------------------
if(DEFINED ENV{SPACK_CC})

  set(CMAKE_C_COMPILER "/home/axom/axom_tpls/none-none/compiler-wrapper-1.0-u5fjo4cce7cqt6425ipfxnafausfog7z/libexec/spack/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/home/axom/axom_tpls/none-none/compiler-wrapper-1.0-u5fjo4cce7cqt6425ipfxnafausfog7z/libexec/spack/clang/clang++" CACHE PATH "")
...
set(MPI_C_COMPILER "/home/axom/axom_tpls/llvm-19.0.0/mpich-4.2.0-wxhfezauopwtrdjmf6hx32l2jh4yyb25/bin/mpicc" CACHE PATH "")

set(MPI_CXX_COMPILER "/home/axom/axom_tpls/llvm-19.0.0/mpich-4.2.0-wxhfezauopwtrdjmf6hx32l2jh4yyb25/bin/mpicxx" CACHE PATH "")

set(MPI_Fortran_COMPILER "/home/axom/axom_tpls/llvm-19.0.0/mpich-4.2.0-wxhfezauopwtrdjmf6hx32l2jh4yyb25/bin/mpif90" CACHE PATH "")

set(MPIEXEC_EXECUTABLE "/home/axom/axom_tpls/llvm-19.0.0/mpich-4.2.0-wxhfezauopwtrdjmf6hx32l2jh4yyb25/bin/mpirun" CACHE PATH "")
...
set(MFEM_DIR "${TPL_ROOT}/mfem-4.9.0-g3kaipukjvqu677tqztygnik5kzcxhfj" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-mwa7fanurwtkpebryywcggusn4gd7yg2" CACHE PATH "")

set(LUA_DIR "/usr" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-git.3b8b59a1e9be2e1066c0d77372b3bf5956e6d6e2_develop-dkkk27oc7p2gsrq4cslpdsv5qz7g3sbd" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2025.12.0-kulqmeumvx2c36r6rzz7lwndhsv3ot4i" CACHE PATH "")

# OPENCASCADE not built

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-idbd67m2y4b4gnuxxbivm7hvesbbl4q5" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-git.7e5b7a5c0eacc077f9b842abf41c9fc7b996ce0c_master-qv2wv4xikow5wxrhdem6c2dvkxt2cptf" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-git.a8caefa9f4c811b1a114b4ed2c9b681d40f12325_main-y2k23nuv2eya2soe3fznpcgsgt2k2dai" CACHE PATH "")
