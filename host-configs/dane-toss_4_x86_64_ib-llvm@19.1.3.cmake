...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_01_29_13_30_26/none-none/compiler-wrapper-1.0-32dgmtd4fhqezj4ib4pbwjnwrxcuzxs7/libexec/spack/clang/clang" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_01_29_13_30_26/none-none/compiler-wrapper-1.0-32dgmtd4fhqezj4ib4pbwjnwrxcuzxs7/libexec/spack/clang/clang++" CACHE PATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_01_29_13_30_26/llvm-19.1.3" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.5-dmle6tliomp27z2usvm22ukviomsvezy" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-jcvyunoextaorp7eqlrec6s53cnlm7cn" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.9.0-qho2znbjhj2le6bbtw7vu6u3xsum2pc3" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-lw4obzkj7og4qegzmwizuxvotpz4lkot" CACHE PATH "")

set(LUA_DIR "/usr" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-git.3b8b59a1e9be2e1066c0d77372b3bf5956e6d6e2_develop-tk6vqmvsga2oebnzgilq4lz57xuafkqz" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-git.0372fbd6e1f17d7e6dd72693f8b857f3ec7559e9_develop-szryy27okevlutgru2jtvaflqbw6rgax" CACHE PATH "")

set(OPENCASCADE_DIR "${TPL_ROOT}/opencascade-7.8.1-fwujcloxwvdjk22xrygpdpswx4tkp3u4" CACHE PATH "")

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-t7ws2osd4v4fd3bffvzozbcq6gqdlf2i" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-git.9ab0e64d2e328d1fdff2ffebb53f30a899d6a598_master-u5dbyica2utd23dhlivu3xlu5jm4kz5f" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-git.a8caefa9f4c811b1a114b4ed2c9b681d40f12325_main-z32b7c752x5r4p2fgji5rfhxbqyltuws" CACHE PATH "")

set(SCR_DIR "${TPL_ROOT}/scr-3.0.1-cgbl5sb7kix2siwcwv57xzkry6kgssgl" CACHE PATH "")

set(KVTREE_DIR "${TPL_ROOT}/kvtree-1.3.0-e2usbkamf4ies6sntmnlwtu2nzkltqgh" CACHE PATH "")

set(DTCMP_DIR "${TPL_ROOT}/dtcmp-1.1.5-t25ihiw2whyfjbuyc5kbxapiscvs5wh3" CACHE PATH "")

set(SPATH_DIR "${TPL_ROOT}/spath-0.2.0-4arh7twlqiyc6cvxa6i627bhvj32va76" CACHE PATH "")

set(AXL_DIR "${TPL_ROOT}/axl-0.7.1-bnrhlub5ov4zupowegt5eguglxs5plz6" CACHE PATH "")

set(LWGRP_DIR "${TPL_ROOT}/lwgrp-1.0.6-vts7nmjhqaqzp2uqcwqs5tl32ml6rpae" CACHE PATH "")

set(ER_DIR "${TPL_ROOT}/er-0.3.0-nkyqbtlnwzhuzww6lvyqdqkyew6xzub4" CACHE PATH "")

set(RANKSTR_DIR "${TPL_ROOT}/rankstr-0.2.0-nf3ih7rxaa4dfgqe5wujoxdtipfmqdld" CACHE PATH "")

set(REDSET_DIR "${TPL_ROOT}/redset-0.2.0-6ynap7s37t2x46ykj75s7yssdadxa7g5" CACHE PATH "")

set(SHUFFILE_DIR "${TPL_ROOT}/shuffile-0.2.0-q3lg5hzi5gfpwxipsq7uceo7oqkjgy5v" CACHE PATH "")
