...
# Compilers
#------------------------------------------------------------------------------
# Compiler Spec: intel-oneapi-compilers@2025.2.0/pure57vovckospvgxd2lr56fpsa636dr
#------------------------------------------------------------------------------
if(DEFINED ENV{SPACK_CC})

  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/none-none/compiler-wrapper-1.0-uesxbqunebynqp5g2i6r3corj4oval5q/libexec/spack/oneapi/icx" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/none-none/compiler-wrapper-1.0-uesxbqunebynqp5g2i6r3corj4oval5q/libexec/spack/oneapi/icpx" CACHE PATH "")

  set(CMAKE_Fortran_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/none-none/compiler-wrapper-1.0-uesxbqunebynqp5g2i6r3corj4oval5q/libexec/spack/oneapi/ifx" CACHE PATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/intel-oneapi-compilers-2025.2.0" CACHE PATH "")

set(CONDUIT_DIR "${TPL_ROOT}/conduit-0.9.5-lqjx3vlbi5prcmle2gsgc7yopbglp3ab" CACHE PATH "")

set(C2C_DIR "${TPL_ROOT}/c2c-1.8.0-fdbbv7fzmylpoctjgdai2kc4xfcz2vqt" CACHE PATH "")

set(MFEM_DIR "${TPL_ROOT}/mfem-4.9.0-npcozwxpczgzuya2z6iailvycmbbc6nd" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-zhxj7u6hk266vklzloqcp3qlahtbta4l" CACHE PATH "")

set(LUA_DIR "/usr" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-git.3b8b59a1e9be2e1066c0d77372b3bf5956e6d6e2_develop-ppbrbxztecp4363lchwihhymqrhv75un" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-2025.12.0-tdpnmcmwvlz77qwdeupgufa6s5aswwp5" CACHE PATH "")

# OPENCASCADE not built

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.4.0-gxozhembb6br5wkhuxetug25ndaodstk" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-git.7e5b7a5c0eacc077f9b842abf41c9fc7b996ce0c_master-bheefndoamg47jey4mbq2ofgflz7kvz4" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-git.a8caefa9f4c811b1a114b4ed2c9b681d40f12325_main-k4dewbo7oilgt6zjhkze2hyqyc6xn3if" CACHE PATH "")
...
set(PY_NANOBIND_DIR "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/gcc-13.3.1/py-nanobind-2.7.0-iky6agz5lprxpnf2nffxwgqcgiagqiz5/lib/python3.13/site-packages" CACHE PATH "")
...
set(PY_NUMPY_DIR "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_04_22_16_24_28/gcc-13.3.1/py-numpy-2.4.2-to6o5czwkczlh46d6gkubixw5bhzxakl/lib/python3.13/site-packages" CACHE PATH "")
...
set(PY_MPI4PY_DIR "${TPL_ROOT}/py-mpi4py-4.1.1-7mymbwx2ifuqlotydf6dx6hd6wmz4xhd/lib/python3.13/site-packages" CACHE PATH "")
