...
if(DEFINED ENV{SPACK_CC})
  ...
  set(CMAKE_C_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_07_24_07_43_10/none-none/compiler-wrapper-1.1.0-pbd2ayub7z6lkuzpvgsnzfsycl3xbuy3/libexec/spack/gcc/gcc" CACHE PATH "")

  set(CMAKE_CXX_COMPILER "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_07_24_07_43_10/none-none/compiler-wrapper-1.1.0-pbd2ayub7z6lkuzpvgsnzfsycl3xbuy3/libexec/spack/gcc/g++" CACHE PATH "")
...
set(TPL_ROOT "/usr/WS1/axom/libs/toss_4_x86_64_ib/2026_07_24_07_43_10/gcc-13.3.1" CACHE PATH "")
...
set(MFEM_DIR "${TPL_ROOT}/mfem-git.c8ef9676e83c93a9037dbdf3bf0f2d741321e632_master-u6oqii7jjhxgpptheer3fowq46vmrvc7" CACHE PATH "")

set(HDF5_DIR "${TPL_ROOT}/hdf5-1.8.23-rephuaeqmzpcjiazcflzeswdvsbwuvd2" CACHE PATH "")

set(LUA_DIR "/usr" CACHE PATH "")

set(RAJA_DIR "${TPL_ROOT}/raja-git.6e4fe62d810711a0af9020d4e94c6c41c9a6117b_develop-jmywz4ts2sygkyau5dafh6ikwnbjhtye" CACHE PATH "")

set(UMPIRE_DIR "${TPL_ROOT}/umpire-git.f544027ef118133f1ecbc26e64c04ea77c3eb5ae_develop-vlfk7hrrnglk46jwsd7tfpgkcvqed4ox" CACHE PATH "")

# OPENCASCADE not built

set(ADIAK_DIR "${TPL_ROOT}/adiak-0.5.0-rv7mu2xwq332xz2xqgfjtond4hvjlcvi" CACHE PATH "")

set(CALIPER_DIR "${TPL_ROOT}/caliper-git.7e5b7a5c0eacc077f9b842abf41c9fc7b996ce0c_master-56wmby3kxz4tfujjmxqkvklthqkbmyyn" CACHE PATH "")

set(CAMP_DIR "${TPL_ROOT}/camp-git.e75ab64c029aa27c80593715cb2a3ccad7453c8c_main-bfs3xf2vc2vqmawm6kpspcyscpkqxxqc" CACHE PATH "")

set(SCR_DIR "${TPL_ROOT}/scr-3.0.1-basfrtnpqf4c53b4rje6jsvep5zsnrwe" CACHE PATH "")

set(KVTREE_DIR "${TPL_ROOT}/kvtree-1.3.0-mymtbems5iw4xq3kfo6eyzpnbml7xv5m" CACHE PATH "")

set(DTCMP_DIR "${TPL_ROOT}/dtcmp-1.1.5-a3lz6mmn25p3jh4sanryhtd7d6ligiv2" CACHE PATH "")

set(SPATH_DIR "${TPL_ROOT}/spath-0.2.0-hna6nu4oneotlxwcfrvsfmekoh5ppjgi" CACHE PATH "")

set(AXL_DIR "${TPL_ROOT}/axl-0.7.1-r3e4275my4pohksumwdh3alreqir3l5d" CACHE PATH "")

set(LWGRP_DIR "${TPL_ROOT}/lwgrp-1.0.6-hlxl5ibgd7nuqhmyn3644y43u567odhy" CACHE PATH "")

set(ER_DIR "${TPL_ROOT}/er-0.3.0-ct43o2nsxxs3o6lzx2fqq7x6hodycdxj" CACHE PATH "")

set(RANKSTR_DIR "${TPL_ROOT}/rankstr-0.2.0-om247obwembbr3pzzvqelcploi3clul3" CACHE PATH "")

set(REDSET_DIR "${TPL_ROOT}/redset-0.2.0-d7uq623m37qhjj6leet4x3fvx2fesdrq" CACHE PATH "")

set(SHUFFILE_DIR "${TPL_ROOT}/shuffile-0.2.0-o7x3cedrhi2gqwezlgtkszdayyi7aeqp" CACHE PATH "")

set(LIBYOGRT_DIR "${TPL_ROOT}/libyogrt-1.35-mofsq5rrmoqrthm3vbb6qits2zxd7mb5" CACHE PATH "")
